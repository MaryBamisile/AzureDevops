...
Check the link to Ms docs below, to get the details of the configuration required (Audience, Issuer)
...
##### Let's check our app service connecting to the P2S VPN

<img width="1894" height="943" alt="image" src="https://github.com/user-attachments/assets/f1e94569-34fa-4b32-9795-8f81405baad6" />

#### After disconnecting from VPN, it failed

<img width="1908" height="943" alt="image" src="https://github.com/user-attachments/assets/72be53e0-4027-4802-a17a-42e421af9f7f" />

### CHALLENGES FACED:

- My device could not resolve the DNS, I bypassed this by manually editing my host file (C:\Windows\System32\drivers\etc) as admin

- Added this to the bottom: 172.16.3.5  my-webapp11-eehndbbnc4e9f2az.southafricanorth-01.azurewebsites.net 

###### This took me a great deal of my time, hence, I will be revisting this demo for a more permanent solution.
